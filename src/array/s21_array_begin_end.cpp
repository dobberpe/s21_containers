...
// template <typename value_type, size_t _MAX>
// typename array<value_type, _MAX>::const_iterator array<value_type, _MAX>::begin() const{
//   return VectorConstIterator(head_node);
// }


// template <typename value_type, size_t _MAX>
// typename array<value_type, _MAX>::const_iterator array<value_type, _MAX>::end() const{
